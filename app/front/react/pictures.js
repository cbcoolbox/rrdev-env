...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mobx = __webpack_require__(159);

	var _mobxReact = __webpack_require__(160);
	...
	// Data Model
	var AppModel = exports.AppModel = (_class = function () {
	    function AppModel() {
	        _classCallCheck(this, AppModel);

	        this.picsPerPage = 6;

	        _initDefineProp(this, 'showAmount', _descriptor, this);
	    }
	    ...
	    return AppModel;
	}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'showAmount', [_mobx.observable], {
	    enumerable: true,
	...
	var App = (0, _mobxReact.observer)(_class3 = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentDidMount() {
	            var _this = this;
	            $.ajax({
	                url: '../server/pictures.php', // point to server-side PHP script
	        ...
	        value: function componentWillMount() {
	            this.render = _template2.default;
	        }
	    }, {
	        key: 'render',
	...
	_reactDom2.default.render(_react2.default.createElement(App, { pictures: new AppModel() }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if(true)
			module.exports = factory(__webpack_require__(159), __webpack_require__(1), __webpack_require__(158));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function template() {
		...
		if (this.state != null) var pictures = this.state["pix"];
		return _react2.default.createElement(
			"div",
			null,
			_react2.default.createElement(
				"div",
				{ id: "sideNav", className: "sidenav close" },
				_react2.default.createElement(
					"div",
					{ onClick: function onClick() {
							return _this.props.pictures.closeNav();
						}, style: { display: "flex", justifyContent: "flex-end", marginRight: "15px" } },
					_react2.default.createElement("div", { className: "arrowBack" }),
					_react2.default.createElement("div", { className: "arrowBack", style: { marginLeft: "5px" } })
				),
				_react2.default.createElement(
					"a",
					{ href: "#" },
				...
				function () {
					...
					if (model.showAmount) return _react2.default.createElement(
						"div",
						null,
						_react2.default.createElement(
							"h4",
			...
			_react2.default.createElement(
				"div",
				{ style: { display: "flex", marginLeft: "15px", marginBottom: "10px", justifyContent: "flex-start", maxWidth: "45px" } },
				_react2.default.createElement(
					"div",
					{ onClick: function onClick() {
							return model.openNav();
						}, style: { display: "flex" } },
					_react2.default.createElement("div", { className: "arrow" }),
					_react2.default.createElement("div", { className: "arrow", style: { marginLeft: "5px" } })
				)
			),
			function () {
				if (pictures != null) return _react2.default.createElement(
					"div",
					{ style: { display: "flex", flexWrap: "wrap", justifyContent: "space-around" } },
					pictures.map(function (pic, index) {
						return _react2.default.createElement(
							"div",
							{ key: index, style: { display: "flex", alignItems: "center", maxWidth: "500px", flexFlow: "column wrap" } },
							_react2.default.createElement("img", { style: pictureStyle, src: "albums/edited/" + pic.pictureName }),
							_react2.default.createElement(
								"a",
								{ download: pic.pictureName, href: 'albums/edited/fullSize/' + pic.pictureName },
								_react2.default.createElement(
									"button",
									{ style: buttonStyle, className: "btn btn-sm" },
									"Download full size"
								)
							)
						);
